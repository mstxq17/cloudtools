...
public interface FileStoreService {
	...
	/**
	 *
	 * @Title: addFileStore @Description: s新分配仓库返回仓库id @param @param
	...
	/**
	 * 
	    * @Title: getFileStoreById  
	    * @Description: 通过仓库ID获取仓库所有数据
	    * @param @param fileStoreId
	    * @param @return    参数  
	    * @return FileStore    返回类型  
	    * @throws
	 */
